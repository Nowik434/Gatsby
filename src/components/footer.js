      ...
      <footer class="pt-5">
        <div class="row pb-4">
          ...
          <div class="col-md-4 col-sm-12 p-0">
            <h3>Godziny Pracy:</h3>
            <ul class="nav flex-column" >
              <li><p className="mb-1 nav-item open-time">poniedziałek:10:00–20:00</p></li>
              <li><p className="mb-1 nav-item open-time">wtorek:10:00–20:00</p></li>
              <li><p className="mb-1 nav-item open-time">środa:10:00–20:00</p></li>
              <li><p className="mb-1 nav-item open-time">czwartek:10:00–20:00</p></li>
              <li><p className="mb-1 nav-item open-time">piątek:10:00–20:00</p></li>
              <li><p className="mb-1 nav-item open-time">sobota:10:00–20:00</p></li>
              <li><p className="mb-1 nav-item open-time">niedziela:10:00–20:00</p></li>
            </ul>
          </div>
        </div>
